...
if mods["bztin"] and data.raw.item["tinned-cable"] then
  ...
  frep.scale_result("cerys-nuclear-scrap-recycling", "tinned-cable", {independent_probability=2})
end
...
table.insert(data.raw["simple-entity"]["cerys-ruin-small"].minable.results, {type="item", name="tree-seed", amount=1, independent_probability=0.12})
table.insert(data.raw["simple-entity"]["cerys-ruin-medium"].minable.results, {type="item", name="tree-seed", amount=1, independent_probability=0.12})
table.insert(data.raw["simple-entity"]["cerys-ruin-big"].minable.results, {type="item", name="tree-seed", amount=1, independent_probability=0.43})
...
table.insert(data.raw["simple-entity"]["cerys-ruin-small"].minable.results, {type="item", name="low-density-structure", amount=1, independent_probability=0.12})
table.insert(data.raw["simple-entity"]["cerys-ruin-medium"].minable.results, {type="item", name="low-density-structure", amount=1, independent_probability=0.12})
